...
//            $('#logo').attr('src', response.app_customer_logo);
    ...
    if (questionsURL.length > 0) {
        ...
        if (questionsURL[videoIndex].question_type.startsWith("question_")) question_start_time =  new Date();
    ...
    video.onended = function(e) {
        ...
        } else if (questionsURL[videoIndex].question_type.startsWith("question_")) {
    ...
    function updateJob_Question_Status() {
        if (questionsURL[videoIndex].question_type.startsWith("question_")) {
